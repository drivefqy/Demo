...
<%
    ...
    String str = "admin + root + root1 ";
    if (user!=null&&str.contains(user)){
        ...
        double count = Double.parseDouble(String.format("%.2f", Math.random()));
...
<%
 ...
 %>
   ...
   <h2 class="fund"><a href="operation.jsp?new=new"style="text-decoration:none;font: 32px 楷体;color: skyblue;">增加新的管理员(需超级管理员权限)</a></h2>
<%
}
else {
%>
