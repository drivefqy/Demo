...
<div class="max">
    <h2 >增加新的管理员</h2>
    <form action="operation1.jsp" method="post">
        <div class="box0">
            <div class="box1">
...
<%}else {%>
<h2 style="text-align: center;margin-top: 200px ;color: red" >当前管理员非超级管理员，无增加权限</h2>
<h2 style="text-align: center;margin-top: 20px"><a href ='Interface.jsp' style="text-decoration: none; color: red" >点击此处返回主界面</a></h2>
<%}%>
</body>
</html>
