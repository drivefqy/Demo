...
<body>
<div class="top">
    <a href="" class="boxq3">用户预约信息</a>
    <a href="menu.jsp" class="boxq2 test1">菜品详情</a>
    <a href="sum.jsp" class="boxq6 test1" style="width: 186;left: 52%">营业额详情</a>
...
<table>
    <tr><th>序号</th><th>用户账号</th><th>预约时间</th><th>就餐时间</th><th>餐桌号</th><th>状态</th></tr>
    <%
        ...
        if (state1==null){  // 7
           // name      | date1      | date2      | id
            sql ="select * from appoinment where 1=? ORDER BY date2 desc";
        } else {
            sql ="select * from appoinment where date2 = ?";
        }
    ...
    <tr>
        <td colspan="6">
            <a href="appoinment.jsp?page=0"style="text-decoration:none;font: 25px 楷体;color: skyblue;">第一页</a>&nbsp;&nbsp;
            <a href="appoinment.jsp?page=<%=pagenow-1%>" style="text-decoration:none;font: 25px 楷体;color: skyblue;">上一页</a>&nbsp;&nbsp;
            <span style="font:28px 楷体">当前页<%=pagenow+1%> </span>&nbsp;&nbsp;
            <a href="appoinment.jsp?page=<%=pagenow+1%>" style="text-decoration:none;font: 25px 楷体;color: skyblue;">下一页</a>&nbsp;&nbsp;
            <a href="appoinment.jsp?page=<%=sum_page-1%>"style="text-decoration:none;font: 25px 楷体;color: skyblue;">最后一页</a>
        </td>
    </tr>
    <tr>
        <td colspan="6">
            <a href="Interface.jsp"style="text-decoration:none;font: 25px 楷体;color: skyblue;">返回主界面</a>
        </td>
    </tr>
</table>
<%
